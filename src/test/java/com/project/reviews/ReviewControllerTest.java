...
public class ReviewControllerTest {
    ...
    public void shouldFindAllReviewsInModel() throws Exception {
        ...
        when(reviewRepo.reviewAll()).thenReturn(allReviewsInModel);
    ...
    public void shouldBeOkForOneReviewInTheCourseTemplate() throws Exception {
        Long reviewOneId = 1L;
        when(reviewRepo.reviewOne(reviewOneId)).thenReturn(reviewOne);
    ...
    public void shouldBeNotFoundForRequestNotInModel() throws Exception {
        Long reviewTwoId = 2L;
        when(reviewRepo.reviewOne(reviewTwoId)).thenReturn(reviewTwo);
